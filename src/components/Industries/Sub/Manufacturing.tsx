      ...
      <ContentContainer>
        <div className="py-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-start">
              ...
              <p className="text-[#222222] py-1 px-2 text-xs lg:text-base">
                With cyber attacks on the rise, security officers are facing
                more pressure than ever to protect both{" "}
                <span className="font-semibold"> IT and OT networks.</span> It
                is imperative for{" "}
                <span className="font-semibold">SCADA and ICS networks</span> to
                keep policies and procedures updated to secure information
                safety.
              </p>
            </div>
            <div className="flex items-start">
            ...
            <div className="flex items-start">
              <span className="pr-2">&bull;</span>
              <p className="text-[#222222] py-1 px-2 text-xs lg:text-base">
                We provide your team with the most efficient incident response
                and recovery preparation and planning possible helping owners
                defend their{" "}
                <span className="font-semibold">
          ...
          <div className=" py-5 lg:py-10">
            ...
            <Cards cardsData={MANU_CARDS_DATA} conatinerClass="mt-5" />
          </div>
        </div>
      </ContentContainer>
      <Features
