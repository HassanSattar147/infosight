          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-start">
              ...
              <p className="text-[#222222] py-1 px-2 text-xs lg:text-base">
                ...
                that test and monitor your network&apos;s infrastructure;
                keeping you <span className="font-semibold">secure</span> from
                any breaches that could occur.
              </p>
            </div>
          </div>
          <div className="py-5 lg:py-10">
            <h3 className="lg:text-lg text-[#222222] font-semibold">
