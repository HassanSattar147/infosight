      ...
      <>
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            With so many data sources and devices along with the growing threat
        ...
        <div className="p-2 flex">
          <span className="pr-2 text-gray-600">&bull;</span>
          <p>
            <span className="font-bold text-gray-600">Tool Overload - </span>{" "}
            Adding tools for specific components across the data center and the
            cloud leads to tool overload, and in many cases many of the tools
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            Data Sources must be tuned to eliminate information, unnecessary and
      ...
      <>
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            We own incident/problem management from creation to closure.
          </p>
        </div>
        <div className="p-2 flex">
          <span className="pr-2 text-gray-600">&bull;</span>
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            Case Management Tickets are automatically created by the monitoring
            tools or manually created by authorized InfoSight, Client or Client
            staff to track incident investigations to closure.
          </p>
        </div>
        <div className="p-2 flex">
          <span className="pr-2 text-gray-600">&bull;</span>
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            We alert the client of incidents via escalation protocols based on
        ...
        <div className="p-2 flex">
          ...
          <p>
            ...
            We provide monthly incident-based reporting.
          </p>
        </div>
      </>
    ),
    ...
    <ServicePageLayout
      ...
      overviewDescription={
        <p className=" text-justify text-[#444444]">
          ...
          leverage your cloud native toolset our ours, the choice is yours!
        </p>
      }
